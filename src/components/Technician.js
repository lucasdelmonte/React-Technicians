...
export default class Technician extends Component {
    render() {
        return <tr>
                ...
                <td><button className="styleEdit" onClick={this.props.updateTechnician}><i class="fas fa-edit"></i></button><button className="styleTrash" onClick={this.props.deleteTechnician.bind(this, this.props.technician.id)}><i class="fas fa-trash"></i></button></td>
        </tr>
    }
}